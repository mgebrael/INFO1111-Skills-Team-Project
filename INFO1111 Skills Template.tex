...
\subsubsection*{Requirements definition and management}
The 2012 McKinsey-Oxford study found that half of all large IT projects massively exceed their budgets, with 17\% having budget overruns more than 200\% – the biggest issues identified being unclear objectives and missing focus. For this reason, defining what is required of a new system is an important skill within all branches of computer science. By using the requirements life cycle approach to ensure that achievable objectives are set and monitored throughout development, the final outcome can be more clearly understood, thus reducing the risk of software projects failing to meet their requirements.

\subsubsection*{Programming/software development}
Programming is a fundamental skill within computer science. It allows professionals to solve problems and develop software components that appeal to stakeholders. A computer scientist should be familiar with implementing development methods, which may include responsibilities such as planning, testing, documentation, security, software recovery, resolving bugs, and using peer review techniques (such as pair programming). Some programming languages that are commonly used by computer scientists include Java, C, Python, and Javascript, amongst many others. As the industry is ever-changing, it is also an important skill to be able to self-learn other programming languages when the need arises.
...
\subsubsection*{Programming and Software Development}
...
\subsubsection*{Systems and Software Life Cycle Engineering} 
...
Information Security is foundational in the cyber security industry because it encompasses the policies, strategies, and practices designed to protect digital and non-digital information from unauthorized access, disclosure, modification, or destruction. As cyber threats become more sophisticated and pervasive, the ability to develop robust security frameworks that safeguard data integrity, confidentiality, and availability becomes critical. Professionals with expertise in information security are essential for identifying vulnerabilities, implementing protective measures, and ensuring organizational resilience against cyber-attacks, thereby maintaining trust and compliance in a digital world.

\subsubsection*{Security Operations}
Security Operations play a pivotal role in the cyber security industry by providing the ongoing management and technical support necessary to enforce security policies and strategies in real-time. This skill is key because it involves the continuous monitoring of network and system activities to detect, analyze, and respond to incidents that could potentially harm an organization's information assets. In an era where cyber threats are constantly evolving, the ability to swiftly identify and mitigate risks through effective security operations is crucial for minimizing potential damage and maintaining operational continuity.

\subsubsection*{Vulnerability Assessment}
Vulnerability Assessment is a critical skill in cyber security due to the constant emergence of new vulnerabilities and the evolving nature of cyber threats. Professionals skilled in vulnerability assessment proactively identify, classify, and prioritize vulnerabilities in software and networks. This process is essential for preemptively addressing weaknesses before they can be exploited by attackers, thereby reducing the attack surface. Effective vulnerability assessment forms the basis for a proactive security posture, enabling organizations to adapt their defenses in alignment with the dynamic cyber threat landscape, and safeguard sensitive data and systems.
